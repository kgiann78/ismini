...
public class ShoppingListActivity extends AppCompatActivity
    ...
    Product[] products = ProductsDummy.getProducts();
    ListView mProducts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProducts = (ListView) findViewById(R.id.shopping_list);
        mAdaptor = new ProductAdapter(ShoppingListActivity.this, products);
